        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserTagParticipationId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTagParticipationQuestion", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserTagParticipationQuestion_UserTagParticipations_UserTagP~",
                        column: x => x.UserTagParticipationId,
