        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserEditorId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "QuestionChangingHistories",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionChangingHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuestionChangingHistories_Questions_QuestionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionChangingHistories_QuestionId",
                table: "QuestionChangingHistories",
                column: "QuestionId");
